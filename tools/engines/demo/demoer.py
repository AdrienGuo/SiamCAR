...
class Demoer(object):
    ...
    def build_dataloader(self):
        ...
        pcbdataset = get_pcbdataset(self.args.method)
    ...
    def create_save_dirs(self):
        ...
        save_dir = os.path.join(
            "./results", self.args.part, self.args.dataset, self.args.criteria, self.args.target, self.args.method,
            model_dir, model_ckpt)
        create_dir(save_dir)
        print(f"Demo results saved in: {save_dir}")
