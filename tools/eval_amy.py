...
parser.add_argument('--save',type=str, default='./results_recall/recall.txt',help='save path')
parser.add_argument('--dataset', type=str, default='./datasets/test/',
                    help='dataset path')
parser.add_argument('--annotation', default='./results/PCB/snapshot/', type=str,help='annotation_path')
